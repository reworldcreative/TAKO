...
export function initCategorySliders(categoryItem) {
...
export function moreDescription(categoryItem) {
  const moreDescriptionButtons = categoryItem.querySelectorAll('.category-item__more');
